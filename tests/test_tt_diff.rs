...
#[tokio::test]
async fn test_new_day() {
    test_main("tests/test.less_events.json", "tests/test.new_day.json", "Уважаемый(ая) Энди Уорхол!<br><br> В расписании преподавателя <b>Энди Уорхол</b> произошли изменения:<br><br><em style=\"color:green;\">Новый день:</em><br><b><font size=\"5\">Среда:</font></b><br>    <b>Предмет:</b> Истоки поп-арта<br>    <b>Время:</b> 13:00-14:30<br>    <b>Даты:</b> 02.09.1968, 10.09.1968<br>    <b>Места:</b> 33 Union Square West<br>    <b>Направления:</b> Группа 103C<br><br> <br> Данное письмо было сгенерировано автоматически, направление ответа не подразумевается.").await;
}

#[tokio::test]
async fn test_old_day_new_event() {
    test_main("tests/test.less_events.json", "tests/test.old_day_new_event.json", "Уважаемый(ая) Энди Уорхол!<br><br> В расписании преподавателя <b>Энди Уорхол</b> произошли изменения:<br><br><b><font size=\"5\">Понедельник:</font></b><br><em style=\"color:green;\">Новые события:</em><br>    <b>Предмет:</b> Истоки поп-арта<br>    <b>Время:</b> 13:00-14:30<br>    <b>Даты:</b> 02.09.1968, 10.09.1968<br>    <b>Места:</b> 33 Union Square West<br>    <b>Направления:</b> Группа 103C<br><br> <br> Данное письмо было сгенерировано автоматически, направление ответа не подразумевается.").await;
}

#[tokio::test]
async fn test_old_day_old_event_new_group() {
    test_main("tests/test.less_events.json", "tests/test.old_day_old_event_new_group.json", "Уважаемый(ая) Энди Уорхол!<br><br> В расписании преподавателя <b>Энди Уорхол</b> произошли изменения:<br><br><b><font size=\"5\">Понедельник:</font></b><br><em style=\"color:green;\">Новые события:</em><br>    <b>Предмет:</b> Как превратить искусство в массовый продукт<br>    <b>Время:</b> 08:30-10:00<br>    <b>Даты:</b> 01.09.1963<br>    <b>Места:</b> 231 East 47th Street<br>    <b>Направления:</b> Группа 101A, Группа 101B<br><br><em style=\"color:red;\">Удалённые события:</em><br>    <b>Предмет:</b> Как превратить искусство в массовый продукт<br>    <b>Время:</b> 08:30-10:00<br>    <b>Даты:</b> 01.09.1963<br>    <b>Места:</b> 231 East 47th Street<br>    <b>Направления:</b> Группа 101A<br><br> <br> Данное письмо было сгенерировано автоматически, направление ответа не подразумевается.").await;
}

#[tokio::test]
async fn test_new_educator() {
    test_main("tests/test.only_warhol.json", "tests/test.less_events.json", "Уважаемый(ая) Энди Уорхол!<br><br> В расписании преподавателя <b>Казимир Малевич</b> произошли изменения:<br><br><em style=\"color:green;\">Новый день:</em><br><b><font size=\"5\">Вторник:</font></b><br>    <b>Предмет:</b> От кубизма к супрематизму<br>    <b>Время:</b> 09:00-10:30<br>    <b>Даты:</b> 29.12.1915<br>    <b>Места:</b> Дворцовая площадь, д. 6/8<br>    <b>Направления:</b> Группа 201A, Группа 201B<br><br> <br> Данное письмо было сгенерировано автоматически, направление ответа не подразумевается.").await;
}

#[tokio::test]
async fn test_delete_last_event_of_the_day() {
    test_main("tests/test.new_day.json", "tests/test.less_events.json", "Уважаемый(ая) Энди Уорхол!<br><br> В расписании преподавателя <b>Энди Уорхол</b> произошли изменения:<br><br><b><font size=\"5\">Среда:</font></b><br><em style=\"color:red;\">Удалённые события:</em><br>    <b>Предмет:</b> Истоки поп-арта<br>    <b>Время:</b> 13:00-14:30<br>    <b>Даты:</b> 02.09.1968, 10.09.1968<br>    <b>Места:</b> 33 Union Square West<br>    <b>Направления:</b> Группа 103C<br><br> <br> Данное письмо было сгенерировано автоматически, направление ответа не подразумевается.").await;
}
